# 🚀 Journey from Zero to Code

Welcome to my coding journey! 🌟 This repository is a dedicated record of my hard work, daily progress, and my transition from having **zero coding knowledge** to building the web from scratch.

I am currently teaching myself web development through **freeCodeCamp**, documenting every milestone—from my very first HTML tag to building functional layouts.
